...
const careSettingOptions = [
    ...
    { value: CareSetting.WARD_A, label: 'Ward A' },
    { value: CareSetting.WARD_B, label: 'Ward B' },
];
 ...
 */
const TopHeader: React.FC<TopHeaderProps> = ({ careSetting, onCareSettingChange, onAddPatient }) => {
    return (
        <header
