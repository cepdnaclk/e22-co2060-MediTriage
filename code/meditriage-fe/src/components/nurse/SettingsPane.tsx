...
const SettingsPane: React.FC<SettingsPaneProps> = ({ user, onLogout }) => {
                ...
                <div className="bg-[#f8f9fa] rounded-[32px] p-8 flex flex-col gap-6">
                    <div className="flex items-center gap-3">
                        ...
                        <h4 className="text-lg font-bold text-gray-900">
                            {user.role === UserRole.DOCTOR ? 'Doctor' : 'Nurse'} Profile
                        </h4>
                    </div>
                    ...
                    <div className="bg-white rounded-[24px] p-6 flex items-center gap-5 shadow-sm border border-gray-50">
                        <img
                            src={user.avatar || '/assets/images/Nurse.jpg'}
                            alt={user.name}
                        ...
                        <div className="flex flex-col">
                            ...
                            <p className="text-xs font-mono text-gray-400 mt-0.5">ID: {user.username}</p>
                        </div>
                    </div>
