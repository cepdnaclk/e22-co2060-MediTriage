...
const SettingsPane: React.FC<SettingsPaneProps> = ({ user, onLogout, onUpdateUser, showToast }) => {
                    ...
                    <div className="bg-gray-50 rounded-[32px] p-8 border border-gray-100 col-span-1" style={{ background: '#f5f5f5', border: 'none' }}>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-4 p-4 bg-white rounded-2xl shadow-sm border border-gray-50">
                                <img src={user?.avatar || '/assets/images/Nurse.jpg'} alt="Avatar" className="w-16 h-16 rounded-full border-2 border-gray-100 object-cover" />
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400 mt-1">ID: {user?.username}</p>
                                </div>
                            </div>
                            ...
                            <div className="p-5 bg-white rounded-2xl shadow-sm border border-gray-50">
                                ...
                                <p className="text-xs text-gray-400 mt-3 font-medium">
                                    This name is visible to doctors when assigning patients and on clinical notes.
                                </p>
                            </div>
                        </div>
                    </div>
