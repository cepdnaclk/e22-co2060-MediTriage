"""
OpenAI provider adapter (Final Release Phase).
Stub implementation — same interface, direct OpenAI usage.
Activate by setting ACTIVE_LLM=OPENAI in environment.
"""
import logging
...
class OpenAIProvider(BaseReasoningProvider):
    """
    OpenAI LLM adapter using LangChain.
    Implements the BaseReasoningProvider interface for the Final Release phase.
    """
